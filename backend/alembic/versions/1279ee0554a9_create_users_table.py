...
def upgrade() -> None:
    ...
    sa.Column('rental_price_per_hour', sa.DECIMAL(precision=10, scale=2), nullable=False),
    ...
    sa.CheckConstraint('rental_price_per_hour >= 0', name='check_rental_price_positive'),
